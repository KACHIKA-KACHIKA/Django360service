...
ROLES = [('employee', 'Employee'), ('team_lead', 'Team Lead'), ('hr_manager', 'HR Manager')]
...
class Session(models.Model):
    ...
    evaluated = models.ForeignKey(User, on_delete=models.CASCADE, related_name="evaluated_sessions")
    is_active = models.BooleanField(default=True)
...
class Assessment(models.Model):
    ...
    evaluator = models.ForeignKey(User, on_delete=models.CASCADE, related_name="given_assessments")
...
class SessionCompetency(models.Model):
    ...
    competency = models.ForeignKey(Competency, on_delete=models.CASCADE, related_name="sessions")
...
class Evaluator(models.Model):
    session = models.ForeignKey(Session, on_delete=models.CASCADE, related_name="evaluators")
